    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Всего сотрудников</p>
          <p className="text-2xl font-black font-mono text-slate-900 mt-1">{totalUsersCount}</p>
        </div>
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-emerald-600">Активных учетных записей</p>
          <p className="text-2xl font-black font-mono text-emerald-600 mt-1">{activeUsersCount}</p>
        </div>
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-orange-600">Сконфигурировано ролей</p>
          <p className="text-2xl font-black font-mono text-orange-600 mt-1">{rolesCount}</p>
        </div>
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <p className="text-[11px] font-bold uppercase tracking-wider text-blue-600">Филиалов предприятия</p>
          <p className="text-2xl font-black font-mono text-blue-600 mt-1">{branches.length || 1}</p>
        </div>
      </div>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm font-medium focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
                    ...
                    <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                      {canEditRole && (
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 bg-orange-50 hover:bg-orange-100 text-[#ea580c] py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                        >
          ...
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border border-slate-200">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-sm font-bold shadow-md shadow-rose-600/20"
              >
                Удалить
              </button>
            </div>
